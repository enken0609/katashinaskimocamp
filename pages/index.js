        ...
        <main className='min-h-screen bg-base-500'>
          ...
          <section className='events mb-2 px-10 pb-10'>
            <div className='w-full mb-6'>
              ...
              <p className="text-base-900 font-bold">{t.EVENT}</p>
            </div>
            <div className="text-right relative h-0 bottom-14">
              <Image src='/images/mizubasho.png' width={70} height={64} className="absolute right-0"/>
            </div>
            {events.length > 0 ? (
              <>
                <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5'>
                  {events.map((events) => (
                    <a href={events.link} key={events.id} className="hover:opacity-75 duration-200 z-50" target="_blank">
                ...
                <div className='mt-8 text-center'>
                  <Link href="/events" className="inline-block py-2 text-white bg-base-900 px-7 hover:opacity-75 duration-200 rounded-lg">
                    {t.BTN_TO_EVENT}
                  </Link>
                </div>
              </>
          ...
          <section className='aboutus mb-2 px-10 pt-6 pb-10'>
            <div className='w-full'>
              <div className="relative h-0 bottom-32 left-0 md:left-8">
                <Image src='/images/tree.png' width={96} height={137} className="absolute"/>
              </div>
            ...
            <div className='mt-8 text-center'>
              <Link href="/rental" className="inline-block py-2 text-white bg-base-900 px-7 hover:opacity-75 duration-200 rounded-lg">
                {t.BTN_MORE_DETAIL}
              </Link>
            </div>
          </section>
          <section className='rental_private_lesson mb-2 pb-10 pt-6 px-10'>
            <div className="relative h-0 bottom-16 text-right right-0 md:right-10">
              <Image src='/images/mountain.png' width={135} height={67} className="absolute right-0"/>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 -mt-2">
              <div className="rental border-4 border-base-900 bg-white p-6 md:p-10 md:mr-1 mb-4 z-10">
                ...
                <div className="text-center">
                  <p className="text-base-900 mb-4">{t.TOP_RENTAL_DESCRIPTION}</p>
                  <Link href="/rental">
                      <Image src='/images/ksc_rental.jpg' width={500} height={435} className='w-full mb-4 rounded-lg hover:opacity-75 duration-200'/>
                  </Link>
                </div>
              </div>
              <div className="private_lesson border-4 border-base-900 bg-white p-6 md:p-10 md:mr-1 mb-4 z-10">
                <div className="flex items-center mb-4">
                  <div className="flex-1 mr-2">
                    <hr className="border-base-900 border-t-2"/>
                  </div>
                ...
                <div className="text-center">
                  <p className="text-base-900 mb-4">{t.TOP_PRIVATE_LESSON_DESCRIPTION}</p>
          ...
          <section className='coach mb-2 p-10'>
            <div className='w-full mb-6'>
              ...
              <p className="text-base-900 font-bold">{t.COACH}</p>
            </div>
            <div className="w-full">
              <div className="relative h-0 bottom-32 text-center">
                <Image src='/images/tree.png' width={96} height={137} className="absolute right-1/2"/>
              </div>
              <div className="mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-white w-full shadow-lg rounded-lg p-12 flex flex-col justify-center items-center">
                    <div className="mb-8">
                      <Image src='/images/kazuakihoshino.jpg' width={300} height={300} className='object-center object-cover rounded-full h-36 w-36' />
                    </div>
                    <div className="text-center">
                      <p className="text-xl text-gray-900 font-bold mb-2">{t.KAZUAKI_HOSHINO}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KAZUAKI_HOSHINO_DESCRIPTION_1}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KAZUAKI_HOSHINO_DESCRIPTION_2}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KAZUAKI_HOSHINO_DESCRIPTION_3}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KAZUAKI_HOSHINO_DESCRIPTION_4}</p>
                      <div className='pt-4 flex justify-center space-x-2'>
                        <a href="https://www.instagram.com/hoshinodash/" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                        ...
                        <a href="https://www.facebook.com/kazuaki.hoshino.94" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                          <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-white w-full shadow-lg rounded-lg p-12 flex flex-col justify-center items-center">
                    ...
                    <div className="text-center">
                      <p className="text-xl text-gray-900 font-bold mb-2">{t.AYAKA_UEDA}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.AYAKA_UEDA_DESCRIPTION_1}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.AYAKA_UEDA_DESCRIPTION_2}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.AYAKA_UEDA_DESCRIPTION_3}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.AYAKA_UEDA_DESCRIPTION_4}</p>
                      <div className='pt-4 flex justify-center space-x-2'>
                        <a href="https://www.instagram.com/ayacan182/" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                          <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                              <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clipRule="evenodd"></path>
                          </svg>
                        </a>
                        <a href="https://www.facebook.com/search/top?q=ayaka%20ueda" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                          <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                              <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                          </svg>
                        </a>
                  ...
                  <div className="bg-white w-full shadow-lg rounded-lg p-12 flex flex-col justify-center items-center">
                    ...
                    <div className="text-center">
                      <p className="text-xl text-gray-900 font-bold mb-2">{t.KENTA_ENDO}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KENTA_ENDO_DESCRIPTION_1}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KENTA_ENDO_DESCRIPTION_2}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KENTA_ENDO_DESCRIPTION_3}</p>
                      <p className="text-xs text-gray-900 font-normal">{t.KENTA_ENDO_DESCRIPTION_4}</p>
                      <div className='pt-4 flex justify-center space-x-2'>
                        <a href="https://www.instagram.com/enken0609/" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                          <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                              <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm-.081 1.802h-.468c-2.456 0-2.784.011-3.807.058-.975.045-1.504.207-1.857.344-.467.182-.8.398-1.15.748-.35.35-.566.683-.748 1.15-.137.353-.3.882-.344 1.857-.047 1.023-.058 1.351-.058 3.807v.468c0 2.456.011 2.784.058 3.807.045.975.207 1.504.344 1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 3.098 3.098 0 00-1.15-.748c-.353-.137-.882-.3-1.857-.344-1.023-.047-1.351-.058-3.807-.058zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clipRule="evenodd"></path>
                          </svg>
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=100005796331083" className="text-base-900 hover:opacity-75 duration-200" target="_blank">
                          <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                              <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                          </svg>
                        </a>
          ...
          <section className='faq mb-2 px-10 pt-10'>
            <div className='w-full mb-6'>
              ...
              <p className="text-base-900 font-bold mb-4">{t.FAQ}</p>
              <div className="text-right relative h-0 bottom-20">
                <Image src='/images/mizubasho.png' width={96} height={88} className="absolute right-0"/>
              </div>
          ...
          <section className='faq mb-2 p-10'>
            <div className="relative w-full rounded-md">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                ...
                <Link href="/contact" className="text-base font-semibold border-white">
                  {t.CONTACT}
                </Link>
              </div>
            </div>
