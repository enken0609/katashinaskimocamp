        ...
        <main className='min-h-screen bg-base-500'>
          ...
          <section className='rental p-4 md:p-10'>
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.SKI_SET}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
                  <Image src='/images/gear_ski.jpg' width={200} height={200} className='rounded-lg' />
                </div>
                <div>
                  <table className="table-auto mx-auto w-full mb-5 sm:mt-4">
                    <thead>
                      <tr>
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.BOOTS}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.SKINS}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.POLES}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.BACKPACK}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
            ...
            <div className='my-8 w-full md:w-4/5 mx-auto shadow-md p-8 bg-white rounded-md'>
              <h2 className="border-b pb-1 mb-5 font-bold text-xl">{t.HELMET}</h2>
              <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                <div className="w-full text-center">
